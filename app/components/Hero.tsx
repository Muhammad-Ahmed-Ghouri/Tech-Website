  ...
  return (
    <section className="hero-section bg-white h-full flex flex-col overflow-hidden" id="homepage-hero">
      <div className="section-container relative flex-1 flex flex-col justify-between py-4 md:py-6 lg:py-8">
        ...
        <div className="title-wrap absolute top-4 md:top-6 lg:top-8 left-0 w-full flex flex-col md:flex-row justify-between pt-10 px-1017 md:px-1035 lg:px-1104 gap-4 md:gap-8 pb-4 z-10 pointer-events-none">
